...
\usepackage[
    style     = numeric,      % references format style i.e. ieee
...
\thesistitle{Search for High-Molecular Weight Linear Polymers for the Formulation of Novel Solutions for the Fabrication of Micro-Fibers by Electromechanical Spinning}
% Fabrication of Suspended Nanowires Through Mechano-Near-Field Electrospinning of Polymers in Solution for the Production of Glass-like Carbon
...
\include{Appendices/Appendix_ViscosityCurves}
\include{Appendices/Appendix_CriticalConcentrations}
\include{Appendices/Appendix_MicroscopyChar}
\include{Appendices/Appendix_FiberDiameters}
\include{Appendices/Appendix_ReviewTable}
\include{Appendices/Appendix_ImageAnalysisCode}
